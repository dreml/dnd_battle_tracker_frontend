...
export const BATTLE_TEMPLATES = "battle-templates";
...
export const ROUTE_BATTLE_TEMPLATE_LIST = `${ROUTE_LIBRARY}/${BATTLE_TEMPLATES}`;
export const getRouteBattleTemplateEdit = (id: string) =>
